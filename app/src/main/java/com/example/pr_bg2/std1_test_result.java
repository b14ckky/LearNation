...
public class std1_test_result extends AppCompatActivity {

    CircularProgressBar circularProgressBar;
    TextView resultText;
    TextView all_ques,wrong_ans;
    ...
    public void onBackPressed() {
        Intent intent = new Intent(std1_test_result.this,standards_test_result.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_std1_test_result);
        back_bt();

        show_ans = findViewById(R.id.std1_show_ans_btn);
        show_ans.setClickable(false);


        ProgressDialog pd = new ProgressDialog(std1_test_result.this);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
               ...
               if (corr == 0)
                {
                    Toast.makeText(std1_test_result.this, "Please give quiz first !! ", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    show_ans.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(std1_test_result.this,std1_Answers.class);
                            startActivity(intent);
                            finish();
                        }
                    });
