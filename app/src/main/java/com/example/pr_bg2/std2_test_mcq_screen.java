...
public class std2_test_mcq_screen extends AppCompatActivity {

    CountDownTimer countDownTimer;
    int timerValue = 20;
    int i = 0;
    RoundedHorizontalProgressBar progressBar;
    List<Modelclass> allQuestionsList2;
    Modelclass modelclass;
    int index2 = 0;
    TextView card_question, optiona, optionb, optionc, optiond;
    CardView cardOA, cardOB, cardOC, cardOD;
    public static int correctCount2 = 0;
    public static int wrongCount2 = 0;
    ...
    public void onBackPressed() {
        Intent back_bt = new Intent(std2_test_mcq_screen.this, std1_test_home_screen.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_std2_test_mcq_screen);


        Hooks();

        allQuestionsList2 = list2;
        modelclass = list2.get(index2);
        ...
        new CountDownTimer(50000, 1000) {
            ...
            public void onFinish() {
                ...
                try {
                    Dialog dialog = new Dialog(std2_test_mcq_screen.this);
                    ...
                    dialog.findViewById(R.id.dialog_retry).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(std2_test_mcq_screen.this, std2_test_home_screen.class);
    ...
    private void SendData() {
        ...
        hashMap.put("Correct", correctCount2);
        hashMap.put("Wrong", wrongCount2);
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
        String currentUserid= user.getUid();
        FirebaseDatabase.getInstance().getReference("UsersTest").child(currentUserid).child("std2_test_counter").updateChildren(Collections.unmodifiableMap(hashMap));
    ...
    private void Result_show() {
        ...
        correctCount2 = 0;
        wrongCount2 = 0;
        Toast.makeText(std2_test_mcq_screen.this, "Your test is completed", Toast.LENGTH_SHORT).show();
        Toast.makeText(std2_test_mcq_screen.this, "To See the Result goto Result section", Toast.LENGTH_SHORT).show();
        Intent result = new Intent(std2_test_mcq_screen.this, std2_test_result.class);
